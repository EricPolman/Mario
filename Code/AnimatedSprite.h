...
public:
	...
	struct AnimationData {Vector2i begin; Vector2i end;float speed;};
	std::map<std::string, AnimationData> m_animations;

	void AddAnimation(std::string name, Vector2i beginFrame, Vector2i endFrame, float animationSpeed = -1);
